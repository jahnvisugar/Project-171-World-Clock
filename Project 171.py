...
india_map = ImageTk.PhotoImage(Image.open("india2.jpg"))
us_map = ImageTk.PhotoImage(Image.open("usa2.jpg"))
australia_map = ImageTk.PhotoImage(Image.open("australia2.jpg"))
japan_map = ImageTk.PhotoImage(Image.open("japan2.jpg"))
